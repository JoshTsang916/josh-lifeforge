        ...
        <div className="grid md:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div className="md:col-span-8 lg:col-span-9 max-w-2xl">
              ...
              <div className="space-y-6 font-sans text-lg leading-[1.8] text-[color:var(--color-fg-muted)]">
                {/* 2026-07-14 橋段（Josh 口述邏輯、AI 串稿、Josh 終審）：
                    從前面的 B2B 敘事（實戰／如何開始鍛造）接進下面的個人哲學。 */}
                <p>
                  我是高中數學老師。學數學，學的是閱讀理解與邏輯推理；教數學讓我能快速找到學生問題背後的根因，把困難的事情變簡單。每個卡點都有原因，也都有解決的方法。有客戶說，跟我合作溝通成本非常低，因為我總是能夠快速切中核心。
                </p>
                <p>
                ...
                <p>
                  ...
                  在這個知識看似垂手可得的時代，我們必須了解真正的知識從來都不是速食，沒有沈澱的知識並不會留下來，只會不著痕跡地滑過大腦的間隙。而閱讀本身要求我們靜下來，去思索、去整理知識，跟自己的現狀碰撞出新的自己。
                </p>
                <p>
